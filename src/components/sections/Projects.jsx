        ...
        <Container id="Projects">
            <Wrapper>
                ...
                <CardContainer>
                    ...
                    {toggle === "web app" && projects.filter(project => project.category === "web app").map((project, index2) => <ProjectCard key={index2} project={project} />)}
                    {toggle === "android app" && projects.filter(project => project.category === "Android App").map((project, index3) => <ProjectCard key={index3} project={project} />)}
                </CardContainer>
            </Wrapper>
        </Container>
    )
